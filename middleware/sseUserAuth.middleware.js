/**
 * JWT auth for user-facing SSE where EventSource cannot set Authorization (browser).
 * Accepts `Authorization: Bearer <token>` or `?access_token=<token>` (any verified user).
 */
...
const authenticateUserSse = async (req, res, next) => {
...
module.exports = { authenticateUserSse };
