...
const getCSRFToken = asyncHandler(async (req, res) => {
  ...
  return res.success(HTTP_STATUS.OK, 'CSRF token retrieved successfully', {
    csrfToken: token,
    message: 'Include this token in X-CSRF-Token header for POST, PUT, DELETE, and PATCH requests'
  });
});
