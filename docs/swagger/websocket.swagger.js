 ...
 *       - `tournament:live-results-updated` - Live match results updated (host submitted match result). Emitted to participants, host, tournament subscribers. Payload: `{ tournamentId, type: 'live-results-updated', matchResults, standings, matchResultsCount, status, totalMatches, timestamp }`. Subscribe via `subscribe:tournament` or `subscribe:user-tournaments` for real-time standings.
